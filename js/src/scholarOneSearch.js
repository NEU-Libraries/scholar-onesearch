...
jQuery(function($) {
  var scholarOneSearch = (function(){
    ...
    var buildViewOnline = function( result ){
      var viewonline = result.$el.find(".EXLViewOnlineTab.EXLResultTabIconPopout a");
      if (viewonline) {
        viewonline = viewonline.attr("href");
        if (viewonline != undefined){
      ...
      var single_viewonline = result.$el.find(".EXLViewOnlineTab.EXLResultSelectedTabEXLResultTabIconPopout a");
